...
- Local, single-user, no accounts — no auth or DB servers ever
- DELETE DUPLICATION, NOT CAPABILITY
...
- [`backend/AGENTS.md`](backend/AGENTS.md) — FastAPI app: ingestion, extraction, graph build, exports, jobs, store
- [`frontend/AGENTS.md`](frontend/AGENTS.md) — React + Vite SPA (force-graph visualization, upload, exports)
- [`docs/AGENTS.md`](docs/AGENTS.md) — project documentation assets (pipeline diagram, screenshots)
- [`plans/AGENTS.md`](plans/AGENTS.md) — working plan files for feature work
